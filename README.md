...
- **Compositor**: [picom-allusive](https://aur.archlinux.org/packages/picom-allusive)
- **Gtk-theme** = [siduck-onedark](https://github.com/siduck/dotfiles/tree/master/gtk/siduck-onedark)
